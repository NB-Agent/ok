// Command ok is the Wails shell around the OK kernel: a native
...
// a nested module (github.com/NB-Agent/ok/desktop) so the CGO/WebKit desktop build never touches
...
import (
	...
	// cmd/ok does — boot.Build resolves providers/tools from these registries.
...
func main() {
	...
	err := wails.Run(&options.App{
		...
		Windows: &windows.Options{
			...
			WindowClassName: "OK_Agent_Window",
		},
		Linux: &linux.Options{
			ProgramName: "OK",
