...
export const zh: Record<DictKey, string> = {
  ...
  // 输入框
  "composer.placeholder": "给 OK 发消息…  ( / 命令 · @ 文件 )",
  ...
  "memory.noDocs": "未找到 OK.md。可在上方快速添加一条。",
  ...
  "settings.tabMode": "模式与规则",
  "settings.tabSandbox": "沙箱",
  "settings.tabIntegrations": "集成",
  "settings.tabAppearance": "外观",
  "settings.modelsDesc": "配置模型 Provider、API 密钥和默认模型。",
  "settings.modeDesc": "设置交互风格和工具调用权限规则。",
  "settings.sandboxDesc": "控制 bash 隔离和网络出口。",
  "settings.permissionRules": "权限规则",
  "settings.mcpPlugins": "MCP 插件",
  "settings.mcpHint": "连接外部 MCP 服务器以扩展工具和能力。",
  "settings.noPlugins": "未配置插件。添加一个来扩展智能体能力。",
  "settings.addPlugin": "添加插件",
  "settings.pluginName": "插件名称",
  "settings.pluginCommand": "命令（如 npx）",
  "settings.pluginArgs": "参数",
  "settings.pluginUrl": "服务器 URL（https://…）",
  "settings.modelRouter": "模型路由",
  "settings.routerEnabled": "按任务复杂度路由",
  "settings.cheapModel": "廉价模型（简单任务）",
  "settings.expensiveModel": "昂贵模型（复杂任务）",
  "settings.appearanceDesc": "自定义界面外观和 UI 语言。",
  ...
  "settings.setKey": "设置 {env} API 密钥",
  "settings.saveKey": "保存密钥",
  "settings.permissions": "权限",
  "settings.denyTitle": "拒绝规则",
  "settings.noRules": "未设置拒绝规则。所有写操作工具将询问批准。",
  "settings.addRuleInput": "例如 bash(rm *) 或 edit_file ...",
  "settings.writerMode": "写操作模式",
  "settings.modeNormal": "普通——写操作前询问",
  "settings.modePlan": "计划——只读，提交计划",
  "settings.modeYolo": "YOLO——自动执行所有操作",
  "settings.ruleForm": "格式：ToolName 或 ToolName(glob)。优先级：deny > ask > allow。",
  ...
  "settings.sandboxTitle": "沙箱",
  "settings.bashSandbox": "Bash 沙箱",
  "settings.bashSandboxLabel": "Bash 执行模式",
  "settings.bashEnforce": "隔离执行（沙箱内）",
  "settings.bashOff": "关闭（不受限运行）",
  "settings.allowNetwork": "允许网络出口",
  "settings.workspaceRoot": "工作区根目录",
  "settings.workspaceDefault": "（默认：当前目录）",
  "settings.allowWriteDirs": "额外允许写入的目录",
  ...
  "settings.codegraphHint": "内置代码智能引擎",
  "settings.editToml": "直接编辑 {path} 获得完整控制。",
  "settings.botPlatforms": "机器人平台",
  "settings.botHint": "填入对应平台的链接或密钥即可直联。",
  "settings.botConfigure": "点击配置",
  "settings.botDesc": "填入上述凭据后，在终端运行对应的 bot 二进制即可启动服务。",
