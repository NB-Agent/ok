...
export const en = {
  ...
  // composer
  "composer.placeholder": "Message OK…  ( / commands · @ files )",
  ...
  "memory.noDocs": "No OK.md found. Quick-add one above.",
  ...
  "settings.tabMode": "Mode & Rules",
  "settings.tabSandbox": "Sandbox",
  "settings.tabIntegrations": "Integrations",
  "settings.tabAppearance": "Appearance",
  "settings.modelsDesc": "Configure model providers, API keys, and default models.",
  "settings.modeDesc": "Set the interaction style and permission rules for tool calls.",
  "settings.sandboxDesc": "Control bash isolation and network egress.",
  "settings.permissionRules": "Permission rules",
  "settings.mcpPlugins": "MCP Plugins",
  "settings.mcpHint": "Connect external MCP servers for additional tools and capabilities.",
  "settings.noPlugins": "No plugins configured. Add one to extend the agent.",
  "settings.addPlugin": "Add plugin",
  "settings.pluginName": "plugin name",
  "settings.pluginCommand": "command (e.g. npx)",
  "settings.pluginArgs": "args",
  "settings.pluginUrl": "server URL (https://…)",
  "settings.modelRouter": "Model Router",
  "settings.routerEnabled": "Route tasks by complexity",
  "settings.cheapModel": "Cheap model (simple tasks)",
  "settings.expensiveModel": "Expensive model (complex tasks)",
  "settings.appearanceDesc": "Customize the look & feel and UI language.",
  ...
  "settings.updateKey": "Update API key",
  ...
  "settings.setKey": "Set {env} API key",
  "settings.saveKey": "Save key",
  "settings.permissions": "Permissions",
  "settings.denyTitle": "Deny rules",
  "settings.noRules": "No deny rules set. All writer tools will prompt for approval.",
  "settings.addRuleInput": "e.g. bash(rm *) or edit_file ...",
  "settings.writerMode": "Writer mode",
  "settings.modeNormal": "Normal — prompt before writers",
  "settings.modePlan": "Plan — read-only, propose plan",
  "settings.modeYolo": "YOLO — auto-run all tools",
  "settings.ruleForm": "Format: ToolName or ToolName(glob). Precedence: deny > ask > allow.",
  ...
  "settings.codegraphHint": "Built-in code intelligence engine",
  "settings.editToml": "Edit {path} directly for full control.",
  "settings.botPlatforms": "Bot Platforms",
  "settings.botHint": "Paste webhook URL or token to connect.",
  "settings.botConfigure": "Configure",
  "settings.botDesc": "Fill in credentials above, then run the bot binary from your terminal.",
