...
//
// The kernel's ok.toml `language` is the cross-surface source of truth (CLI +
...
// Accepts any ISO language code; UI falls back to en for unsupported locales.
export type LangPref = string;
