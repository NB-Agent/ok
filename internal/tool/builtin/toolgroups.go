...
func (t *toolGroupsTool) Description() string {
	return "Control visible tools. Start with 'core' (files/search/task/bash), then activate 'advanced' (git/db/debug/desktop/workflow), 'knowledge' (rag/search), or 'admin'. Groups: core, advanced, knowledge, admin."
}
