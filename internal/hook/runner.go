...
// ConsumeRollback reports whether the last tool was rolled back. Shell-hook
// Runners never roll back — only the DST compile/test hooks do.
func (r *Runner) ConsumeRollback() (string, string, bool) { return "", "", false }
