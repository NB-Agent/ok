...
// would need.
//
// OK ships the CodeGraph bundle alongside its own executable, so Resolve
...
// BundleDirName is the directory, beside the ok executable, that the release
...
// bundled looks for the CodeGraph launcher unpacked beside the ok binary.
...
// EnsureInit initializes CodeGraph for root when it has not been already, by
