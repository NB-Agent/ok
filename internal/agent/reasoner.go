		...
		if attempt < 2 {
			...
			reGoal := goal +
				fmt.Sprintf("\n\nPREVIOUS ATTEMPT FAILED:\n  Error: %v\n  Summary of completed+failed tasks:\n%s\n\n"+
					...
					"  If regex failed → try fuzzy matching with character normalization\n"+
					"  If fuzzy failed → try line-by-line heuristics\n"+
					"  If heuristics failed → try AI-assisted extraction\n"+
