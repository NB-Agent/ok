...
- Writing .go: precheckGoFile checks Go syntax before writing. On error, fix — nothing written.
...
// ModeStyle returns "yolo" — the only interaction mode.
// The agent always runs in full-automation mode without per-tool approval.
