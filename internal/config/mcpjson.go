...
// mcpJSONFile is the project-root file Claude Code calls .mcp.json. OK reads
...
// already declare. ok.toml's [[plugins]] win on a name collision: it is the
// ok-specific, more explicit of the two, so it overrides the shared,
